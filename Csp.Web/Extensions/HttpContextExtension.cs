...
namespace Csp.Web.Extensions
{
    ...
    public static class HttpContextExtension
    {
        ...
        public async static Task ExceptionResponse(this HttpContext context)
        {
            ...
            //重设响应内容
            await context.Response.WriteAsync(OptResult.Failed(error?.Message).ToString());
        ...
        public async static Task StatusCodeResponse(this HttpContext context)
        {
            ...
            {
                await context.Response.WriteAsync(OptResult.Failed(context.Response.StatusCode.StatusCodeToString()).ToString());
            }
        }
